            ...
            <div class="login-bg-color bg-black-300">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel login-box" style="background:#A00A8F">
                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter your School ID</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Enter Your School ID" autocomplete="off" name="rollid">
                                	</div>
                               <div class="form-group">
